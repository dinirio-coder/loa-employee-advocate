...
export const getEmployeeNextMilestone = (employee, options = {}) => {
  ...
  const normalizedStatus = normalizeEmployeeLeaveStatus(employee);
  ...
  if (normalizedStatus.statusKey.startsWith("PENDING")) { label = "Submit your documentation"; timing = "Check the deadline in MyLincoln Portal"; basis = "Submit your required documentation through MyLincoln Portal by the deadline shown there."; }
  else if (stageId === "pre-leave") { label = "Apply for leave with Lincoln"; timing = "As soon as possible"; basis = "Start your leave request with Lincoln."; }
